<?php
  ...
  // select user
  $users = mysqli_query($config, "SELECT * FROM tbl_user WHERE nama != 'Administrator'");
    ...
    <form class="col s12" method="post" action="">
        ...
        <div class="row">
            <div class="input-field col s6">
                ...
                <div class="input-field col s11 right">
                    <select class="browser-default validate" name="tujuan" id="tujuan" required>
                        ...
                        <option <?= $row['tujuan'] == $user['id_user'] ? 'selected' : ''?>
            ...
            <div class="input-field col s6">
                ...
                <input id="batas_waktu" type="text" name="batas_waktu" class="datepicker"
                    value="<?php echo $row['batas_waktu']; ?>" required>
                <?php
            ...
            <div class="input-field col s6">
                ...
                <textarea id="isi_disposisi" class="materialize-textarea validate" name="isi_disposisi"
                    required><?php echo $row['isi_disposisi'] ;?></textarea>
                <?php
            ...
            <div class="input-field col s6">
                ...
                <input id="catatan" type="text" class="validate" name="catatan" value="<?php echo $row['catatan'] ;?>"
                    required>
                <?php
                                    ...
                                    ?>
                <label for="catatan">Asal Surat</label>
            </div>
            <div class="input-field col s6">
            ...
            <div class="row">
                ...
                <div class="col 6">
                    <a href="?page=tsm&act=disp&id_surat=<?php echo $row['id_surat']; ?>"
                        class="btn-large deep-orange waves-effect waves-light">BATAL <i
